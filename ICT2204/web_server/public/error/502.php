...
<body>
    <div class="container">
        <h1><span class="text">502 </span><span class="normal">Bad Gateway</span></h1>
       <p><script>document.write(window.location.hostname)</script>&nbsp;received an invalid response from an inbound server.</p>
