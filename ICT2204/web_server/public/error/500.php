...
<body>
    <div class="container">
        <h1><span class="text">500 </span><span class="normal">Internal Server Error</span></h1>
       <p>An unexpected condition was encountered on&nbsp;<script>document.write(window.location.hostname)</script>.</p>
       <a onclick="window.history.back();" class="btn-big btn-primary"><i class="fas fa-hand-point-left"></i> go back</a>
    </div>
    <!-- import JS -->
